...
def main() -> int:
    ...
    if versions["versions"][0].get("digitalRevision") != "114.0.0-beta.2.2" or versions["versions"][0].get("status") != "Beta":
        errors.append("versions.json is not marked 114.0.0-beta.2.2 Beta")
    ...
    for path in html_files:
        ...
        if "114.0.0-beta.2.2" not in document or "Beta" not in document:
