...
def main() -> int:
    ...
    manual = {
        ...
        "pdfPages": EXPECTED_PAGES, "digitalRevision": "114.0.0-beta.2.6.1", "releaseStatus": "Beta", "sha256": SHA256,
    ...
    write_json(ROOT / "data" / "versions.json", {"currentVersion": "114", "versions": [{
        ...
        "pdfPages": 359, "digitalRevision": "114.0.0-beta.2.6.1", "status": "Beta",
